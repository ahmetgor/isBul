...
export class IlanSer {
  ...
  createDb() {
     this.ilanlar = [
      {id: 13, isim: 'Çağrı Merkezi Müşteri Temsilcisi Temsilcisi', firma: 'I2I-Systems', aciklama: 'developer aranıyor', il: 'İstanbul', tip:'Yarı Z.', egitim: 'Lisans', tecrube: 'Az Tecrübeli (Junior)', ehliyet: 'B', askerlik: 'Yapıldı/Muaf', goruntulenme: '', basvuru: '', olusturan:'', olusurmaTarih:'25.03.2017', guncelleyen:'', guncellemeTarih:'' },
      {id: 14, isim: 'Analist', firma: 'I2I-Systems', aciklama: 'analist aranıyor', il: 'İstanbul', tip:'Tam Z.', egitim: 'Lisans', tecrube: 'Çok Tecrübeli (Senior)', ehliyet: 'B', askerlik: 'Yapıldı/Muaf', goruntulenme: '', başvuru: '', olusturan:'', olusurmaTarih:'', guncelleyen:'', guncellemeTarih:'' },
